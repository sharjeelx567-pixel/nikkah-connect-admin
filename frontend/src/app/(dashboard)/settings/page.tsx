...
import { Save, ShieldAlert, Sliders, ToggleLeft, ToggleRight, DollarSign } from 'lucide-react';
    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="glass p-6 border border-primary/10 rounded-3xl shadow-neon-primary premium-card space-y-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { key: 'allowRegistration' as const, label: 'Allow Registrations', desc: 'Temporarily allow or freeze new user accounts signups.' },
      ...
      <div className="glass p-6 border border-primary/10 rounded-3xl shadow-neon-primary premium-card space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6 text-xs">
          <div>
            <label className="block font-semibold uppercase tracking-wider text-text-secondary mb-1">Monthly Plan Rate ($USD)</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-text-secondary font-medium">
          ...
          <div>
            <label className="block font-semibold uppercase tracking-wider text-text-secondary mb-1">Yearly Plan Rate ($USD)</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-text-secondary font-medium">
                <DollarSign className="w-4 h-4" />
              </span>
